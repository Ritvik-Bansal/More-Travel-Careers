    ...
    <>
      <header className="flex gap-5 justify-between self-center px-5 w-full text-lg font-medium max-w-[1271px] max-md:flex-wrap max-md:max-w-full">
        ...
        <nav className="flex gap-5 my-auto text-black max-md:flex-wrap">
          ...
          <NavItem>Life at More Travel</NavItem>
          <NavItem>Hiring Tips</NavItem>
        ...
        <section className="max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[64%] max-md:ml-0 max-md:w-full">
              <h1 className="flex flex-col mt-7 text-7xl font-semibold text-zinc-800 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
