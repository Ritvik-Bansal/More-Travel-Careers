...
(function () {
  ...
  const createChatLi = (message, className) => {
    ...
    let chatContent =
      className === 'outgoing'
        ? `<p></p>`
        : `<span className="material-symbols-outlined">smart_toy</span><p></p>`;
    chatLi.innerHTML = chatContent;
    chatLi.querySelector('p').textContent = message;
    return chatLi; // return chat <li> element
  };

  function submitForm(prop) {
    console.log(prop);
  }
        ...
        messages: [
          {
            role: 'system',
            content:
              "You are an AI assistant for More Travel, providing information about job opportunities, travel destinations, and more. In the website in which you are implemented in there is a variety of information from diversity in more travel, culture, hiring tips, testimonials, job-openings, an application, internship opportunities, benefits, and flexible work. Users can ask you about any information regarding these topics and you need to help them out. If you think it would be better to give the creators of the websites emails because we have better responses, Ritvik Bansal: ritvikbansal08@gmail.com, Ronak Singh: singhronak2008@gmail.com, Sai Lalith Kanumuri: sailalithkanumuri@gmail.com. Make sure you don't provide the email to every single person and only provide it if the user asks or if you truely believe you didn't answer the question effectively.",
          },
